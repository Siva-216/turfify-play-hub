...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Book premium turf slots for football, futsal, and cricket." },
      { name: "author", content: "TurfZone" },
      { property: "og:title", content: "TurfZone — Book Your Game" },
      { property: "og:description", content: "Book premium turf slots for football, futsal, and cricket." },
